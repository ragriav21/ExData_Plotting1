...
EPCDF.Names <- read.table(unz(temp, "household_power_consumption.txt"), 
...
GlobalActivePowerHist <- hist(ElectricPowerConsumptionDF$Global_active_power, 
...
png("plot1.png")
hist(ElectricPowerConsumptionDF$Global_active_power, 
     main = "Global Active Power",
     xlab = "Global Active Power (Kilowatts)", ylab = "Frequency", col = "red")
dev.off()
